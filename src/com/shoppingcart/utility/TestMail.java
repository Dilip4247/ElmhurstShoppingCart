...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "elmhurstshoppingcart@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Elmhurst Shopping Cart</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Elmhurst Shopping Cart.<br>"
					...
					+ "<span class='greenText'>Elmhurst Shopping Cart500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
