...
<body
	style="background-image: url('images/login.jpeg'); background-size: contain; background-position: center; background-repeat: no-repeat;">
		...
		<div class="row"
			...
			<form action="./LoginSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<marquee class="GeneratedMarquee" direction="right"
						scrollamount="4" behavior="scroll">Welcome to Elmhurst
						Shopping Cart</marquee>
