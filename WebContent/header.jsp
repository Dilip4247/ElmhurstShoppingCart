...
<%@ page import="com.shoppingcart.service.impl.*,com.shoippingcart.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color:  #5cbdb9; color: white; padding: 5px;">
		<h1>Elmhurst Shopping Cart</h1>
		<h3>We specialize in Electronics</h3>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Elmhurst Shopping Cart</a>
			</div>
