...
<body style="background-image: url('images/'); background-size: contain; background-position: center; background-repeat: no-repeat;">
    ...
    <p id="blink">	As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 50 USD for the first product purchase.
</p>
